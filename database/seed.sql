...
INSERT INTO users (id, email, password, created_at) VALUES
  ('a1000000-0000-0000-0000-000000000001', 'alice@vanwallet.id',   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', now() - interval '30 days'),
  ('a2000000-0000-0000-0000-000000000002', 'budi@vanwallet.id',    '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', now() - interval '29 days'),
  ('a3000000-0000-0000-0000-000000000003', 'citra@vanwallet.id',   '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', now() - interval '28 days'),
  ('a4000000-0000-0000-0000-000000000004', 'dian@vanwallet.id',    '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', now() - interval '27 days'),
  ('a5000000-0000-0000-0000-000000000005', 'eko@vanwallet.id',     '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', now() - interval '26 days');

-- -------------------------------------------------------------
-- 2. PROFILES
-- -------------------------------------------------------------
INSERT INTO profiles (id, user_id, full_name, phone, created_at) VALUES
...
-- -------------------------------------------------------------
INSERT INTO user_pins (id, user_id, pin_hash, failed_attempts, created_at) VALUES
  (gen_random_uuid(), 'a1000000-0000-0000-0000-000000000001', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', 0, now()),
  (gen_random_uuid(), 'a2000000-0000-0000-0000-000000000002', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', 0, now()),
  (gen_random_uuid(), 'a3000000-0000-0000-0000-000000000003', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', 0, now()),
  (gen_random_uuid(), 'a4000000-0000-0000-0000-000000000004', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', 0, now()),
  (gen_random_uuid(), 'a5000000-0000-0000-0000-000000000005', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh.K', 0, now());

-- -------------------------------------------------------------
-- 4. WALLETS (1 per user, initial balance 1.000.000 IDR)
-- -------------------------------------------------------------
INSERT INTO wallets (id, user_id, label, balance, created_at) VALUES
...
-- EXPENSE x4
INSERT INTO transactions (id, wallet_id, type, amount, admin_fee, status, note, created_at) VALUES
...
INSERT INTO expenses (transaction_id, category, merchant_name) VALUES
...
INSERT INTO withdrawals (transaction_id, bank_name, account_number, account_holder) VALUES
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c1070000-0000-0000-0000-000000000001', 'c2080000-0000-0000-0000-000000000002', 'TRF-ALICE-BUDI-001', now() - interval '19 days');
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c1090000-0000-0000-0000-000000000001', 'c3100000-0000-0000-0000-000000000003', 'TRF-ALICE-CITRA-001', now() - interval '18 days');
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c2070000-0000-0000-0000-000000000002', 'c4090000-0000-0000-0000-000000000004', 'TRF-BUDI-DIAN-001', now() - interval '17 days');
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c3070000-0000-0000-0000-000000000003', 'c5090000-0000-0000-0000-000000000005', 'TRF-CITRA-EKO-001', now() - interval '16 days');
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c3080000-0000-0000-0000-000000000003', 'c1110000-0000-0000-0000-000000000001', 'TRF-CITRA-ALICE-001', now() - interval '15 days');
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c4070000-0000-0000-0000-000000000004', 'c5100000-0000-0000-0000-000000000005', 'TRF-DIAN-EKO-001', now() - interval '14 days');
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c4080000-0000-0000-0000-000000000004', 'c2110000-0000-0000-0000-000000000002', 'TRF-DIAN-BUDI-001', now() - interval '13 days');
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c5070000-0000-0000-0000-000000000005', 'c1120000-0000-0000-0000-000000000001', 'TRF-EKO-ALICE-001', now() - interval '12 days');
...
INSERT INTO transfers (transaction_id, recipient_transaction_id, transfer_code, created_at) VALUES
  ('c5080000-0000-0000-0000-000000000005', 'c2120000-0000-0000-0000-000000000002', 'TRF-EKO-BUDI-001', now() - interval '11 days');
